...
function renderLanding(){
    ...
    let contentText = "Like, did you think whatever weak buns you've \
    eaten until now were good?<br>Think again.<br>They're straight garbage \
    compared to this Tomfoolery.";
